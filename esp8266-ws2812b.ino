...
const char* ssid = "mywifirouter";        //WIFI Router                      
const char* password = "mypassword";      //WIFI Password
const char* host = "api.thingspeak.com";  //We read the data from this host                                   
const int httpPortRead = 80;                           //               

const char* url1 = "/apps/thinghttp/send_request?api_key=EDXA3KZY8BAMHSQE";     //TSLA
const char* url2 = "/apps/thinghttp/send_request?api_key=L77XYLL3P7MDX0HC";     //TEAM
const char* url3 = "/apps/thinghttp/send_request?api_key=K4Y0B6UMTBA5889Z";     //GME
const char* url4 = "/apps/thinghttp/send_request?api_key=QD4J1K4C7KTJ3B54";     //AMC   
const char* url5 = "/apps/thinghttp/send_request?api_key=07607U4KY5D6EHVN";     //APPH
...
void displayled(){
  ...
  inputString = (titil+" "+"$"+Amount+" "+"^"+"+"+Increase+" "+"^"+"+"+Ratio+" ");
    ...
    if ((currentChar >= 'A') && (currentChar <= 'Z')) {
      ...
      colorMode = 1; //originally 2 switching to 1
      currentCol = colorMode;
    } else if ((currentChar == '|') || (currentChar >= '0') && (currentChar <= '9') && (currentChar == '%')){
      colorMode = 2; //originally 1 switching to 2
      currentCol = colorMode;
    }
    else if ((currentChar == '$')|| (currentChar >= '0') && (currentChar <= '9') && (currentChar == '%')) {
      colorMode = 4;
